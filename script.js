function submit(){
    var measurement1 = parseInt(document.getElementById("write measurement 1").value);
    var measurement2 = parseInt(document.getElementById("write measurement 2").value);
    var measurement3 = parseInt(document.getElementById("write measurement 3").value);
